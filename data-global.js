...
const characters = [
    ...
    { name: "Hinata SR", role: "MB", img: "img-global/hinataSR.png", school: "Karasuno", bonds: ["Teammates on the Court"] },
    { name: "Kageyama SSR", role: "S", img: "img-global/tobioSSR.png", school: "Karasuno", bonds: ["Teammates on the Court"] },
    { name: "Daichi SSR", role: "OP", img: "img-global/daichiSSR.png", school: "Karasuno", bonds: ["Karasuno\'s Pillar","karasuno Senior Year"] },
    { name: "Daichi SR", role: "OP", img: "img-global/daichiSR.png", school: "Karasuno", bonds: ["Karasuno\'s Pillar(practice)"] },
    ...
    { name: "Asahi SR", role: "WS", img: "img-global/asahiSR.png", school: "Karasuno", bonds: ["\"Guardian Deity\" and \"Ace\"","Leaders Cut from the Same Cloth","Karasuno\'s Wing Spiker"] },
    ...
    { name: "Nishinoya SR", role: "Li", img: "img-global/nishinoyaSR.png", school: "Karasuno", bonds: ["\"Guardian Deity\" and \"Ace\"","Formidable Opponent"] },
    ...
    { name: "Tanaka SR", role: "WS", img: "img-global/tanakaSR.png", school: "Karasuno", bonds: ["Karasuno\'s Wing Spiker",] },
    { name: "Tsukishima SSR", role: "MB", img: "img-global/tsukishimaSSR.png", school: "Karasuno", bonds: ["\"Sheild\" and \"Spear\"",] },
    { name: "Tsukishima SR", role: "MB", img: "img-global/tsukishimaSR.png", school: "Karasuno", bonds: ["Simulated Junior Training Teamate","\"Sheild\" and \"Spear\"(practice)"] },
    { name: "Tadashi SR", role: "MB", img: "img-global/tadashiSR.png", school: "Karasuno", bonds: ["\"Sheild\" and \"Spear\"",] },
    { name: "Tadashi R", role: "MB", img: "img-global/tadashiR.png", school: "Karasuno", bonds: ["\"Sheild\" and \"Spear\"(practice)"] },
    { name: "Chikara SR", role: "WS", img: "img-global/chikaraSR.png", school: "Karasuno", bonds: ["Karasuno\'s sophomore", "Karasuno\'s Pillar"] },
    { name: "Chikara R", role: "WS", img: "img-global/chikaraR.png", school: "Karasuno", bonds: ["Karasuno\'s Wing Spiker","Karasuno\'s Pillar(practice)"] },
    { name: "Hisashi R", role: "WS", img: "img-global/hisashiR.png", school: "Karasuno", bonds: ["Bench cheer",] },
    { name: "Kazuhito R", role: "WS", img: "img-global/kazuhitoR.png", school: "Karasuno", bonds: ["Bench cheer",] },
...
const synergyDescriptions = {
    ...
    "\"Guardian Deity\" and \"Ace\"":"When Nishinoya or Asahi casts a skill, increases their Attack Technique by 7/8/9/10%",
    ...
    "Surprising Friendship":{"Aone SSR": "Block +5/7/9/12/15, Block +1/2/3/4/5%"},
    ...
    "Karasuno\'s Pillar(practice)": {"Daichi SR":"Block +5/7/9/12/15, Block +1/2/3/4/5%","Chikara R": "Receive +5/7/9/12/15, Receive +1/2/3/4/5%"},
    "\"Sheild\" and \"Spear\"(practice)": "Increases Tsukishima Block stat by 6/7/8/9/10% and Tadashi Serve stat by 6/7/8/9/10%",
...
const synergyMeta = {
    ...
    "\"Sheild\" and \"Spear\" (practice)":{ category: "deployment", activation: { scope: "any", min: 2 } },
...
const synergyPairs = {
    ...
    "Leaders Cut from the Same Cloth":[["Asahi", "Kuroo"]],
    ...
    "\"Sheild\" and \"Spear\"(practice)": [["Tsukishima SR", "Tadashi R"]],
